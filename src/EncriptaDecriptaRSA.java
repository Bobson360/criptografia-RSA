...
public static void main(String[] args) {
    ...
    try {
      ...
      final String msgOriginal = " = 1 => (1 * 7) mod 160 = 7\" que não satisfaz a condição, pois o resultado foi “7”. Se tomarmos os números etc.";
      ...
      String s = new String(textoCriptografado);
